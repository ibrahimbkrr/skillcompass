...
class ProjectExperiencePastProjects extends StatelessWidget {
  final String value;
  ...
  const ProjectExperiencePastProjects({
    super.key,
    required this.value,
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Semantics(
                      label: 'Geçmiş proje deneyimi başlığı',
                      child: Text(
                        'Bilişim alanında hangi projelerde yer aldınız?',
                    ...
                    child: Semantics(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Örneğin: Bir e-ticaret uygulamasında Flutter ile ön yüz geliştirdim.',
                          counterText: '',
              ...
              Semantics(
                label: 'Geçmiş proje ipucu',
                child: Text(
                  'Geçmiş projelerinizi kısaca tarif edin. Kullandığınız teknolojileri belirtmeyi unutmayın.',
