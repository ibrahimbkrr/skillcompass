...
interface ProfilePlatformsCardProps {
  values: string[];
...
const ProfilePlatformsCard: React.FC<ProfilePlatformsCardProps> = ({ values, onChange, error, completed }) => {
  ...
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      <Typography variant="subtitle1" fontWeight={600} color="#2A4B7C" mb={1}>
        Hangi platformlarda kişisel markanızı oluşturuyorsunuz?
      </Typography>
      ...
      {showCustom && (
        <Box display="flex" alignItems="center" mb={1}>
          <TextField
            ...
            placeholder="Kendi platformunuzu yazın"
      ...
      <Typography variant="body2" color="#6B7280">
        Kişisel markanızı oluşturduğunuz platformları seçin veya yazın.
      </Typography>
...
export default ProfilePlatformsCard; 