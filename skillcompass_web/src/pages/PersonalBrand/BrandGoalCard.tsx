...
const BrandGoalCard: React.FC<BrandGoalCardProps> = ({ value, onChange, error, completed, showInspire, inspireText, onInspire }) => {
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      ...
      <Box display="flex" alignItems="flex-start" mb={1}>
        <TextField
          ...
          placeholder="Örneğin: GitHub'da 5 açık kaynak projesi paylaşmak."
          error={!!error}
          helperText={error || 'Hedefinizi kısaca açıklayın (en az 10 karakter).'}
          size="small"
