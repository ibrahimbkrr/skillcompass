...
interface CurrentConnectionsCardProps {
  values: string[];
...
const CurrentConnectionsCard: React.FC<CurrentConnectionsCardProps> = ({ values, onChange, error, completed }) => {
  ...
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      <Typography variant="subtitle1" fontWeight={600} color="#2A4B7C" mb={1}>
        Şu anda kimlerle bağlantınız var?
      </Typography>
      ...
      {showCustom && (
        <Box display="flex" alignItems="center" mb={1}>
          <TextField
            ...
            placeholder="Kendi bağlantınızı yazın"
      ...
      <Typography variant="body2" color="#6B7280">
        Mevcut bağlantılarınızı seçin veya yazın.
      </Typography>
...
export default CurrentConnectionsCard; 