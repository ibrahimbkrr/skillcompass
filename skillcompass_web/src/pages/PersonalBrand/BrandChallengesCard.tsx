...
interface BrandChallengesCardProps {
  value: string;
...
const BrandChallengesCard: React.FC<BrandChallengesCardProps> = ({ value, onChange, error, completed, showInspire, inspireText, onInspire }) => {
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      ...
      <Box display="flex" alignItems="flex-start" mb={1}>
        <TextField
          ...
          placeholder="Örneğin: Düzenli içerik üretmek için zaman bulamamak."
          error={!!error}
          helperText={error || 'Zorluğunuzu kısaca açıklayın (en az 10 karakter).'}
          size="small"
...
export default BrandChallengesCard; 