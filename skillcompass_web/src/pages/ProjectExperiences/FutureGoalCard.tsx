...
const FutureGoalCard: React.FC<FutureGoalCardProps> = ({ value, onChange, error, completed, showInspire, inspireText, onInspire }) => {
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      <Typography variant="subtitle1" fontWeight={600} mb={1} color="#2A4B7C">
        Gelecekte gerçekleştirmek istediğiniz bir proje hedefiniz var mı?
      </Typography>
      <Box display="flex" alignItems="flex-start" mb={1}>
        <TextField
          ...
          placeholder="Örneğin: Yapay zeka tabanlı bir eğitim uygulaması geliştirmek istiyorum."
          error={!!error}
          helperText={error || 'Hedeflediğiniz projeyi kısaca açıklayın.'}
          size="small"
