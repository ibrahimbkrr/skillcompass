...
const ContentTypesCard: React.FC<ContentTypesCardProps> = ({ values, onChange, error, completed }) => {
  ...
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      ...
      {showCustom && (
        <Box display="flex" alignItems="center" mb={1}>
          <TextField
            ...
            placeholder="Kendi içerik türünüzü yazın"
      ...
      <Typography variant="body2" color="#6B7280">
        Paylaşmak istediğiniz içerik türlerini seçin veya yazın.
      </Typography>
...
export default ContentTypesCard; 