...
const LongTermGoalCard: React.FC<LongTermGoalCardProps> = ({ value, onChange, error, completed, showInspire, inspireText, onInspire }) => {
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      ...
      <Box display="flex" alignItems="center" mb={1}>
        <TextField
          ...
          placeholder="Örneğin: Bir teknoloji startup'ında teknik lider."
          error={!!error}
          helperText={error || 'Büyük düşünün! 5 yıl içinde ulaşmak istediğiniz vizyonu tarif edin.'}
          size="small"
