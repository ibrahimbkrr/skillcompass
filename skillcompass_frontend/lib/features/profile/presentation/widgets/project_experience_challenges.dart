...
class ProjectExperienceChallenges extends StatelessWidget {
  final String value;
  ...
  const ProjectExperienceChallenges({
    super.key,
    required this.value,
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Semantics(
                      label: 'Proje zorlukları başlığı',
                      child: Text(
                        'Projelerinizde karşılaştığınız en büyük zorluk nedir?',
                    ...
                    child: Semantics(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Örneğin: Ekip koordinasyonu veya teknik hata ayıklama.',
                          counterText: '',
              ...
              Semantics(
                label: 'Proje zorlukları ipucu',
                child: Text(
                  'Zorluklarınızı dürüstçe paylaşın. Size uygun çözümler sunacağız.',
