...
interface PastProjectsCardProps {
  value: string;
...
const PastProjectsCard: React.FC<PastProjectsCardProps> = ({ value, onChange, error, completed, showInspire, inspireText, onInspire }) => {
  return (
    <AnimatedQuestionCard completed={!!completed} borderColor={completed ? '#D4A017' : '#A0AEC0'}>
      ...
      <Box display="flex" alignItems="flex-start" mb={1}>
        <TextField
          ...
          placeholder="Örneğin: Bir e-ticaret uygulamasında Flutter ile ön yüz geliştirdim."
          error={!!error}
          helperText={error || 'Geçmişte yer aldığınız projeleri paylaşın.'}
          size="small"
...
export default PastProjectsCard; 