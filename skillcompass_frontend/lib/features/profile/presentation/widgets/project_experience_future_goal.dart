...
class ProjectExperienceFutureGoal extends StatelessWidget {
  final String value;
  ...
  const ProjectExperienceFutureGoal({
    super.key,
    required this.value,
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Semantics(
                      label: 'Gelecek proje hedefi başlığı',
                      child: Text(
                        'Bir yıl içinde hangi projeyi tamamlamak istiyorsunuz?',
                    ...
                    child: Semantics(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Örneğin: Bir yapay zeka tabanlı sohbet uygulaması geliştirmek.',
                          counterText: '',
              ...
              Semantics(
                label: 'Gelecek proje ipucu',
                child: Text(
                  'Kısa vadeli bir proje hedefi belirleyin. Teknolojileri ve kapsamı düşünün.',
