...
class NetworkingProgressActions extends StatelessWidget {
  ...
  const NetworkingProgressActions({
    super.key,
    ...
    return Column(
      ...
      children: [
          ...
          builder: (context, constraints) {
            ...
            return Row(
              children: [
                ...
                Icon(Icons.hub, color: mainBlue, size: 20),
        ...
        Semantics(
          ...
          child: Text(
            'Ağınızı tanımlayarak profesyonel fırsatlarınızı artırın.',
