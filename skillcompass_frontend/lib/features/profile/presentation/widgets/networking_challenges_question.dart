...
class NetworkingChallengesQuestion extends StatelessWidget {
  final String value;
  ...
  const NetworkingChallengesQuestion({
    super.key,
    required this.value,
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Semantics(
                      label: 'Networking zorlukları başlığı',
                      child: Text(
                        'Ağ oluştururken karşılaştığınız en büyük zorluk nedir?',
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Semantics(
                      label: 'Networking zorlukları girişi',
                      child: TextFormField(
                        initialValue: value,
                        maxLength: 100,
                        minLines: 1,
                        ...
                        decoration: InputDecoration(
                          hintText: 'Örneğin: Yeni insanlarla iletişim kurmakta zorlanma.',
                          counterText: '',
              ...
              Semantics(
                label: 'Networking zorlukları ipucu',
                child: Text(
                  'Zorluklarınızı dürüstçe paylaşın. Size uygun networking stratejileri sunacağız.',
